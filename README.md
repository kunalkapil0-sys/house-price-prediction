...
| **Accuracy score (R²)** | 0.817 |
| **Average house price** | $206,856 |

So a typical guess is off by about **15%** of the home's value.
...
| Model | Average error | R² |
|---|---|---|
| Linear Regression | $50,670 | 0.625 |
| **Random Forest** | **$31,588** | **0.817** |
